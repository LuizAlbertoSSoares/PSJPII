...
//jm	color: navy;
	color: black;
//jm	border-left: 5px #ffe000 solid;
...
do Benificiário</b></div></TD></tr></tbody></table>
		<table class="header" border=0 cellspacing="0" cellpadding="0">
		<tbody>
		<tr>
			<td width=150><IMG SRC="img/logosicoob.jpg"></td>
			<td width=50>
		...
		<tbody>
		<tr class="titulos">
			<td class="Beneficiário">Beneficiário</td>
		...
		<tr class="campos">
			<td class="Beneficiário"><?php echo $dadosboleto["cedente"]; ?>&nbsp;</td>
		...
		<tr class="campos">
			<td class="Pagador"><?php echo $dadosboleto["sacado"]?></td>
		</tr>
		</tbody>
		</table>
		...
		<tr class="titulos">
			...
			<td class="ag_cod_cedente2">Ag&ecirc;ncia/C&oacute;digo do Beneficiário</td>
		</tr>
		<tr class="campos">
			<td class="cedente2"><?php echo $dadosboleto["cedente"]. " - CNPJ: ".$dadosboleto["cpf_cnpj"]?></td>
		...
		<tr class="campos">
			<td class="endereco"><?php echo $dadosboleto["endereco"]?>&nbsp;</td>
			<td class="desconto"><?php echo ""?>&nbsp;</td> 
		</tr>
		</tbody>
		</table>-->
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="titulos">
				<td class="instrucoes">
						Instru&ccedil;&otilde;es (Texto de Responsabilidade do Beneficiário)
				</td>
			</tr>
			<tr class="campos">
